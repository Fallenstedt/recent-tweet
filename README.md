...
I made this repo as a setup for serverless go lang development. You'll find the make file especially useful.
...
aws cloudformation describe-stacks \
    --stack-name hello-sam --query 'Stacks[].Outputs'
```
